	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#30c7ba","headFontSize":"20px","headUserInfoFontColor":"#ffffff","headBoxShadow":"0 2px 8px rgba(0,0,0,.22)","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#1f1f1f","headFontColor":"#ffffff","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"#111111","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"#ffffff","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
